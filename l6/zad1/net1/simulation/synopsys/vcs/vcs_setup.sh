...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/nat1_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv \
  $QSYS_SIMDIR/submodules/nat1_mm_interconnect_0_avalon_st_adapter.v \
  ...
  $QSYS_SIMDIR/submodules/nat1_mm_interconnect_0_rsp_mux.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv \
  $QSYS_SIMDIR/submodules/nat1_mm_interconnect_0_cmd_mux.sv \
  $QSYS_SIMDIR/submodules/nat1_mm_interconnect_0_cmd_demux.sv \
  ...
  $QSYS_SIMDIR/submodules/nat1_mm_interconnect_0_router_001.sv \
  $QSYS_SIMDIR/submodules/nat1_mm_interconnect_0_router.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv \
  $QSYS_SIMDIR/submodules/nat1_master_0_p2b_adapter.sv \
  $QSYS_SIMDIR/submodules/nat1_master_0_b2p_adapter.sv \
  ...
  $QSYS_SIMDIR/submodules/nat1_master_0_timing_adt.sv \
  ...
  $QSYS_SIMDIR/submodules/nat1_mm_interconnect_0.v \
  $QSYS_SIMDIR/submodules/nat1_onchip_memory2_0.v \
  $QSYS_SIMDIR/submodules/nat1_master_0.v \
  $QSYS_SIMDIR/nat1.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
