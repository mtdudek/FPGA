...
module nat1_mm_interconnect_0 (
	...
	nat1_mm_interconnect_0_router router (
	...
	nat1_mm_interconnect_0_router_001 router_001 (
	...
	nat1_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nat1_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nat1_mm_interconnect_0_cmd_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                           //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),     // clk_reset.reset
	...
	nat1_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nat1_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (10),
		.inUsePackets    (0),
		.inDataWidth     (10),
		.inChannelWidth  (0),
