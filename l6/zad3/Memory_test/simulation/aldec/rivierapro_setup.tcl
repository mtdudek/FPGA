...
# ACDS 19.1 670 linux 2019.11.25.22:07:52
# ----------------------------------------
...
# ----------------------------------------
# If Memory_test is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "Memory_test"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Memory_test.v"
}
