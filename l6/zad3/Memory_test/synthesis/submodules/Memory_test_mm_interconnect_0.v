// Memory_test_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module Memory_test_mm_interconnect_0 (
		input  wire        clk_0_clk_clk,                                            //                                          clk_0_clk.clk
		input  wire        Avalon_Master_Memory_0_reset_reset_bridge_in_reset_reset, // Avalon_Master_Memory_0_reset_reset_bridge_in_reset.reset
		input  wire        master_0_clk_reset_reset_bridge_in_reset_reset,           //           master_0_clk_reset_reset_bridge_in_reset.reset
		input  wire [9:0]  Avalon_Master_Memory_0_avalon_master_address,             //               Avalon_Master_Memory_0_avalon_master.address
		output wire        Avalon_Master_Memory_0_avalon_master_waitrequest,         //                                                   .waitrequest
		input  wire        Avalon_Master_Memory_0_avalon_master_chipselect,          //                                                   .chipselect
		input  wire        Avalon_Master_Memory_0_avalon_master_read,                //                                                   .read
		output wire [7:0]  Avalon_Master_Memory_0_avalon_master_readdata,            //                                                   .readdata
		input  wire        Avalon_Master_Memory_0_avalon_master_write,               //                                                   .write
		input  wire [7:0]  Avalon_Master_Memory_0_avalon_master_writedata,           //                                                   .writedata
	...
	wire          avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_waitrequest;   // Avalon_Master_Memory_0_avalon_master_agent:av_waitrequest -> Avalon_Master_Memory_0_avalon_master_translator:uav_waitrequest
	wire    [7:0] avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_readdata;      // Avalon_Master_Memory_0_avalon_master_agent:av_readdata -> Avalon_Master_Memory_0_avalon_master_translator:uav_readdata
	wire          avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_debugaccess;   // Avalon_Master_Memory_0_avalon_master_translator:uav_debugaccess -> Avalon_Master_Memory_0_avalon_master_agent:av_debugaccess
	wire   [31:0] avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_address;       // Avalon_Master_Memory_0_avalon_master_translator:uav_address -> Avalon_Master_Memory_0_avalon_master_agent:av_address
	wire          avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_read;          // Avalon_Master_Memory_0_avalon_master_translator:uav_read -> Avalon_Master_Memory_0_avalon_master_agent:av_read
	wire    [0:0] avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_byteenable;    // Avalon_Master_Memory_0_avalon_master_translator:uav_byteenable -> Avalon_Master_Memory_0_avalon_master_agent:av_byteenable
	wire          avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_readdatavalid; // Avalon_Master_Memory_0_avalon_master_agent:av_readdatavalid -> Avalon_Master_Memory_0_avalon_master_translator:uav_readdatavalid
	wire          avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_lock;          // Avalon_Master_Memory_0_avalon_master_translator:uav_lock -> Avalon_Master_Memory_0_avalon_master_agent:av_lock
	wire          avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_write;         // Avalon_Master_Memory_0_avalon_master_translator:uav_write -> Avalon_Master_Memory_0_avalon_master_agent:av_write
	wire    [7:0] avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_writedata;     // Avalon_Master_Memory_0_avalon_master_translator:uav_writedata -> Avalon_Master_Memory_0_avalon_master_agent:av_writedata
	wire    [0:0] avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_burstcount;    // Avalon_Master_Memory_0_avalon_master_translator:uav_burstcount -> Avalon_Master_Memory_0_avalon_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                                       // rsp_mux:src_valid -> Avalon_Master_Memory_0_avalon_master_agent:rp_valid
	wire   [74:0] rsp_mux_src_data;                                                                        // rsp_mux:src_data -> Avalon_Master_Memory_0_avalon_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                       // Avalon_Master_Memory_0_avalon_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                                     // rsp_mux:src_channel -> Avalon_Master_Memory_0_avalon_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                               // rsp_mux:src_startofpacket -> Avalon_Master_Memory_0_avalon_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                                 // rsp_mux:src_endofpacket -> Avalon_Master_Memory_0_avalon_master_agent:rp_endofpacket
	...
	wire          avalon_master_memory_0_avalon_master_agent_cp_valid;                                     // Avalon_Master_Memory_0_avalon_master_agent:cp_valid -> router:sink_valid
	wire   [74:0] avalon_master_memory_0_avalon_master_agent_cp_data;                                      // Avalon_Master_Memory_0_avalon_master_agent:cp_data -> router:sink_data
	wire          avalon_master_memory_0_avalon_master_agent_cp_ready;                                     // router:sink_ready -> Avalon_Master_Memory_0_avalon_master_agent:cp_ready
	wire          avalon_master_memory_0_avalon_master_agent_cp_startofpacket;                             // Avalon_Master_Memory_0_avalon_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          avalon_master_memory_0_avalon_master_agent_cp_endofpacket;                               // Avalon_Master_Memory_0_avalon_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire   [74:0] onchip_memory2_0_s1_agent_rp_data;                                                       // onchip_memory2_0_s1_agent:rp_data -> router_002:sink_data
	...
	wire   [74:0] router_002_src_data;                                                                     // router_002:src_data -> rsp_demux:sink_data
	...
	wire   [74:0] cmd_mux_src_data;                                                                        // cmd_mux:src_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	wire   [74:0] cmd_demux_001_src0_data;                                                                 // cmd_demux_001:src0_data -> cmd_mux:sink1_data
	...
	wire   [74:0] rsp_demux_src1_data;                                                                     // rsp_demux:src1_data -> rsp_mux_001:sink0_data
	...
	wire          rsp_mux_001_src_valid;                                                                   // rsp_mux_001:src_valid -> master_0_master_rsp_width_adapter:in_valid
	wire   [74:0] rsp_mux_001_src_data;                                                                    // rsp_mux_001:src_data -> master_0_master_rsp_width_adapter:in_data
	wire          rsp_mux_001_src_ready;                                                                   // master_0_master_rsp_width_adapter:in_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                                                 // rsp_mux_001:src_channel -> master_0_master_rsp_width_adapter:in_channel
	wire          rsp_mux_001_src_startofpacket;                                                           // rsp_mux_001:src_startofpacket -> master_0_master_rsp_width_adapter:in_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                                             // rsp_mux_001:src_endofpacket -> master_0_master_rsp_width_adapter:in_endofpacket
	wire          master_0_master_rsp_width_adapter_src_valid;                                             // master_0_master_rsp_width_adapter:out_valid -> master_0_master_agent:rp_valid
	wire  [101:0] master_0_master_rsp_width_adapter_src_data;                                              // master_0_master_rsp_width_adapter:out_data -> master_0_master_agent:rp_data
	wire          master_0_master_rsp_width_adapter_src_ready;                                             // master_0_master_agent:rp_ready -> master_0_master_rsp_width_adapter:out_ready
	wire    [1:0] master_0_master_rsp_width_adapter_src_channel;                                           // master_0_master_rsp_width_adapter:out_channel -> master_0_master_agent:rp_channel
	wire          master_0_master_rsp_width_adapter_src_startofpacket;                                     // master_0_master_rsp_width_adapter:out_startofpacket -> master_0_master_agent:rp_startofpacket
	wire          master_0_master_rsp_width_adapter_src_endofpacket;                                       // master_0_master_rsp_width_adapter:out_endofpacket -> master_0_master_agent:rp_endofpacket
	wire          router_001_src_valid;                                                                    // router_001:src_valid -> master_0_master_cmd_width_adapter:in_valid
	wire  [101:0] router_001_src_data;                                                                     // router_001:src_data -> master_0_master_cmd_width_adapter:in_data
	wire          router_001_src_ready;                                                                    // master_0_master_cmd_width_adapter:in_ready -> router_001:src_ready
	wire    [1:0] router_001_src_channel;                                                                  // router_001:src_channel -> master_0_master_cmd_width_adapter:in_channel
	wire          router_001_src_startofpacket;                                                            // router_001:src_startofpacket -> master_0_master_cmd_width_adapter:in_startofpacket
	wire          router_001_src_endofpacket;                                                              // router_001:src_endofpacket -> master_0_master_cmd_width_adapter:in_endofpacket
	wire          master_0_master_cmd_width_adapter_src_valid;                                             // master_0_master_cmd_width_adapter:out_valid -> cmd_demux_001:sink_valid
	wire   [74:0] master_0_master_cmd_width_adapter_src_data;                                              // master_0_master_cmd_width_adapter:out_data -> cmd_demux_001:sink_data
	wire          master_0_master_cmd_width_adapter_src_ready;                                             // cmd_demux_001:sink_ready -> master_0_master_cmd_width_adapter:out_ready
	wire    [1:0] master_0_master_cmd_width_adapter_src_channel;                                           // master_0_master_cmd_width_adapter:out_channel -> cmd_demux_001:sink_channel
	wire          master_0_master_cmd_width_adapter_src_startofpacket;                                     // master_0_master_cmd_width_adapter:out_startofpacket -> cmd_demux_001:sink_startofpacket
	wire          master_0_master_cmd_width_adapter_src_endofpacket;                                       // master_0_master_cmd_width_adapter:out_endofpacket -> cmd_demux_001:sink_endofpacket
	...
	) avalon_master_memory_0_avalon_master_translator (
		.clk                    (clk_0_clk_clk),                                                                           //                       clk.clk
		.reset                  (Avalon_Master_Memory_0_reset_reset_bridge_in_reset_reset),                                //                     reset.reset
		.uav_address            (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (Avalon_Master_Memory_0_avalon_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (Avalon_Master_Memory_0_avalon_master_waitrequest),                                        //                          .waitrequest
		.av_chipselect          (Avalon_Master_Memory_0_avalon_master_chipselect),                                         //                          .chipselect
		.av_read                (Avalon_Master_Memory_0_avalon_master_read),                                               //                          .read
		.av_readdata            (Avalon_Master_Memory_0_avalon_master_readdata),                                           //                          .readdata
		.av_write               (Avalon_Master_Memory_0_avalon_master_write),                                              //                          .write
		.av_writedata           (Avalon_Master_Memory_0_avalon_master_writedata),                                          //                          .writedata
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) avalon_master_memory_0_avalon_master_agent (
		.clk                   (clk_0_clk_clk),                                                                           //       clk.clk
		.reset                 (Avalon_Master_Memory_0_reset_reset_bridge_in_reset_reset),                                // clk_reset.reset
		.av_address            (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (avalon_master_memory_0_avalon_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (avalon_master_memory_0_avalon_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (avalon_master_memory_0_avalon_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (avalon_master_memory_0_avalon_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (avalon_master_memory_0_avalon_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (avalon_master_memory_0_avalon_master_agent_cp_ready),                                     //          .ready
	...
	altera_merlin_master_agent #(
		...
		.rp_valid              (master_0_master_rsp_width_adapter_src_valid),                        //        rp.valid
		.rp_data               (master_0_master_rsp_width_adapter_src_data),                         //          .data
		.rp_channel            (master_0_master_rsp_width_adapter_src_channel),                      //          .channel
		.rp_startofpacket      (master_0_master_rsp_width_adapter_src_startofpacket),                //          .startofpacket
		.rp_endofpacket        (master_0_master_rsp_width_adapter_src_endofpacket),                  //          .endofpacket
		.rp_ready              (master_0_master_rsp_width_adapter_src_ready),                        //          .ready
		.av_response           (),                                                                   // (terminated)
		.av_writeresponsevalid ()                                                                    // (terminated)
	);
	...
	Memory_test_mm_interconnect_0_router router (
		.sink_ready         (avalon_master_memory_0_avalon_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (avalon_master_memory_0_avalon_master_agent_cp_valid),         //          .valid
		.sink_data          (avalon_master_memory_0_avalon_master_agent_cp_data),          //          .data
		.sink_startofpacket (avalon_master_memory_0_avalon_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (avalon_master_memory_0_avalon_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                               //       clk.clk
		.reset              (Avalon_Master_Memory_0_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
	...
	Memory_test_mm_interconnect_0_router_001 router_001 (
	...
	Memory_test_mm_interconnect_0_router_002 router_002 (
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (Avalon_Master_Memory_0_reset_reset_bridge_in_reset_reset), // cr0_reset.reset
	...
	Memory_test_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                            //       clk.clk
		.reset              (Avalon_Master_Memory_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Memory_test_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                            //       clk.clk
		.reset              (Avalon_Master_Memory_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.sink_ready         (master_0_master_cmd_width_adapter_src_ready),              //      sink.ready
		.sink_channel       (master_0_master_cmd_width_adapter_src_channel),            //          .channel
		.sink_data          (master_0_master_cmd_width_adapter_src_data),               //          .data
		.sink_startofpacket (master_0_master_cmd_width_adapter_src_startofpacket),      //          .startofpacket
		.sink_endofpacket   (master_0_master_cmd_width_adapter_src_endofpacket),        //          .endofpacket
		.sink_valid         (master_0_master_cmd_width_adapter_src_valid),              //          .valid
	...
	Memory_test_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                            //       clk.clk
		.reset               (Avalon_Master_Memory_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Memory_test_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                            //       clk.clk
		.reset              (Avalon_Master_Memory_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Memory_test_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                            //       clk.clk
		.reset               (Avalon_Master_Memory_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Memory_test_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                            //       clk.clk
		.reset               (Avalon_Master_Memory_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (master_0_master_rsp_width_adapter_src_endofpacket),        //       src.endofpacket
		.out_data             (master_0_master_rsp_width_adapter_src_data),               //          .data
		.out_channel          (master_0_master_rsp_width_adapter_src_channel),            //          .channel
		.out_valid            (master_0_master_rsp_width_adapter_src_valid),              //          .valid
		.out_ready            (master_0_master_rsp_width_adapter_src_ready),              //          .ready
		.out_startofpacket    (master_0_master_rsp_width_adapter_src_startofpacket),      //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) master_0_master_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                            //       clk.clk
		.reset                (Avalon_Master_Memory_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		...
		.out_endofpacket      (master_0_master_cmd_width_adapter_src_endofpacket),        //       src.endofpacket
		.out_data             (master_0_master_cmd_width_adapter_src_data),               //          .data
		.out_channel          (master_0_master_cmd_width_adapter_src_channel),            //          .channel
		.out_valid            (master_0_master_cmd_width_adapter_src_valid),              //          .valid
		.out_ready            (master_0_master_cmd_width_adapter_src_ready),              //          .ready
		.out_startofpacket    (master_0_master_cmd_width_adapter_src_startofpacket),      //          .startofpacket
		.in_command_size_data (3'b000)                                                    // (terminated)
	);

	Memory_test_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (10),
		.inUsePackets    (0),
		.inDataWidth     (10),
		.inChannelWidth  (0),
		...
		.in_rst_0_reset (Avalon_Master_Memory_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
